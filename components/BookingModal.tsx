    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#0d1117]/90 border border-white/10 p-8 rounded-3xl shadow-[0_0_40px_rgba(16,185,129,0.2)] backdrop-blur-xl border-t-emerald-500/30">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          {isSuccess ? (
            <div className="py-10 flex flex-col items-center animate-fade-in-up text-center">
              <div className="w-20 h-20 bg-emerald-500/20 text-emerald-400 rounded-full flex items-center justify-center mb-6 border border-emerald-500/30 shadow-[0_0_30px_rgba(16,185,129,0.3)]">
                <svg className="w-10 h-10 animate-float" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">Details Saved!</h3>
              <p className="text-emerald-400/80 font-medium">Redirecting you to WhatsApp...</p>
            </div>
          ) : (
            <>
              <div>
